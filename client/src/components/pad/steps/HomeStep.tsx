...
export function HomeStep({ onSelectPreRegistered, onSelectUnregistered, highlightEntry }: HomeStepProps) {
  return (
    <section className="flex min-h-0 flex-1 flex-col">
      <div className="flex h-full w-full flex-row items-center justify-between gap-20 px-[80px] pb-8 pt-[120px]">
        <div className="flex min-w-0 flex-[1_1_44%] flex-col justify-center">
          ...
          <div className="mt-16 animate-fade-in-up" style={{ animationDelay: "80ms" }}>
            <HomeApplicationStepper />
          </div>
        </div>

        <div className="ml-auto flex w-full max-w-[560px] flex-[1_1_52%] flex-col justify-center gap-4">
          <button
            type="button"
