...
const MOCK_HOSTS = [
  { id: "1", name: "박지훈", dept: "영업팀",    phone: "010-1234-5678", location: "더존을지타워 15층 회의실 A" },
  { id: "2", name: "박지훈", dept: "제품기획팀", phone: "010-9876-5432", location: "더존을지타워 8층 회의실 B" },
  { id: "3", name: "김민준", dept: "인사팀",    phone: "010-1111-2222", location: "더존을지타워 3층 면접실" },
  { id: "4", name: "이수연", dept: "마케팅팀",  phone: "010-3333-4444", location: "더존을지타워 9층 마케팅룸" },
];
