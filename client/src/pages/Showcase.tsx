...
import PVMainPage from "./pad-visitor/PadMainPage";
...
const MOBILE_VISITOR_SCREENS = [
  ...
  { id: "MV-05", name: "방문증 수령 안내",     route: "/visitor/arrival",  component: <MVArrivalPage /> },
  { id: "MV-06", name: "신청 조회",            route: "/visitor/inquiry",  component: <MVInquiryPage /> },
];
...
const PAD_VISITOR_SCREENS = [
  { id: "PV-01", name: "메인화면",               route: "/pad",             component: <PVMainPage /> },
