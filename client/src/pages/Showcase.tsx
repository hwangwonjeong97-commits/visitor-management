...
const MOBILE_VISITOR_PRE_SCREENS = [
  ...
  { id: "MV-03", name: "신청완료 / 승인 대기",   route: "/visitor/waiting",  component: <MVWaitingPage isInvited={true} /> },
...
const MOBILE_VISITOR_NEW_SCREENS = [
  { id: "MV-01", name: "메인화면",              route: "/visitor-new",                    component: <MVMainPage isInvited={false} /> },
